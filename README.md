...
- **[Vicejo](https://github.com/daviwaldow/vicejo)** (in progress): personal agenda / SaaS app, NestJS monorepo + Angular front end, JWT auth, Prisma, i18n in pt/en/es
- **Valorant Round-Win Predictor**: final-year project (TCC), a machine learning model that estimates round-win probability from economic and tactical match data
- **Mini-Sumo Robot**: autonomous ESP32 combat robot, designed, 3D-printed and programmed in C/C++, 1st place in a regional competition
- **Aeroduca (AeroDesign Team)**: radio-controlled cargo aircraft prototypes for SAE Brasil AeroDesign, worked on structure, electronics and engineering calculations

### Certifications

- Oracle Cloud Infrastructure Architect Associate
- Angular 19, Curso Completo do Iniciante ao Avançado (Udemy): Angular Material, Tailwind CSS, RxJS, Micro-frontends
